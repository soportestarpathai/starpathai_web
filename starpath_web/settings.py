...
_default_hosts = "localhost,127.0.0.1,starpathai.mx,www.starpathai.mx,starpathai-web.onrender.com"
ALLOWED_HOSTS = [
    h.strip()
...
for host in ("starpathai.mx", "www.starpathai.mx", "starpathai-web.onrender.com"):
