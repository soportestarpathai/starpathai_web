...
from mi_app.views.orbita.orbita_views import (
    ...
    ATSProfileAvatarUploadView,
    ATSVacancyCreateView,
    ATSVacancyEditView,
    ATSVacancyDeleteView,
    ATSWorkforceDashboardView,
    ATSWorkforceAreaCreateView,
    ATSWorkforceAreaUpdateView,
    ATSWorkforceAreaDeleteView,
    ATSWorkforcePositionCreateView,
    ATSWorkforcePositionUpdateView,
    ATSWorkforcePositionDeleteView,
    ATSWorkforcePlanCreateView,
    ATSWorkforcePlanUpdateView,
    ATSWorkforcePlanDeleteView,
    ATSWorkforcePlanActionView,
    ...
    ATSAdminUpdateModulesView,
    ATSAdminUpdateCVLimitView,
...
urlpatterns = [
    ...
    path("orbita/plataforma/dashboard/candidato/<uuid:public_id>/", ATSCandidateDetailView.as_view(), name="orbita_candidate_detail"),
    path("orbita/plataforma/dashboard/candidato/<uuid:public_id>/subir-cv/", ATSCandidateUploadCVView.as_view(), name="orbita_candidate_upload_cv"),
    path("orbita/plataforma/dashboard/candidato/<uuid:public_id>/analizar-cv/", ATSCandidateAnalyzeCVView.as_view(), name="orbita_candidate_analyze_cv"),
    path("orbita/plataforma/dashboard/candidato/<uuid:public_id>/enviar-correo/", ATSCandidateSendEmailView.as_view(), name="orbita_candidate_send_email"),
    path("orbita/plataforma/dashboard/candidato/<uuid:public_id>/eliminar/", ATSCandidateDeleteView.as_view(), name="orbita_candidate_delete"),
    ...
    path("orbita/plataforma/dashboard/configuracion/cuenta/avatar/", ATSProfileAvatarUploadView.as_view(), name="orbita_profile_avatar_upload"),
    ...
    path("orbita/plataforma/dashboard/reclutamiento/vacante/<uuid:public_id>/editar/", ATSVacancyEditView.as_view(), name="orbita_vacancy_edit"),
    path("orbita/plataforma/dashboard/reclutamiento/vacante/<uuid:public_id>/eliminar/", ATSVacancyDeleteView.as_view(), name="orbita_vacancy_delete"),
    path("orbita/plataforma/dashboard/workforce/", ATSWorkforceDashboardView.as_view(), name="orbita_workforce_dashboard"),
    path("orbita/plataforma/dashboard/workforce/necesidades/", ATSWorkforceDashboardView.as_view(), name="orbita_workforce_needs"),
    path("orbita/plataforma/dashboard/workforce/planeacion/", ATSWorkforceDashboardView.as_view(), name="orbita_workforce_planning"),
    path("orbita/plataforma/dashboard/workforce/areas/", ATSWorkforceDashboardView.as_view(), name="orbita_workforce_areas"),
    path("orbita/plataforma/dashboard/workforce/areas/crear/", ATSWorkforceAreaCreateView.as_view(), name="orbita_workforce_area_create"),
    path("orbita/plataforma/dashboard/workforce/areas/<uuid:public_id>/editar/", ATSWorkforceAreaUpdateView.as_view(), name="orbita_workforce_area_update"),
    path("orbita/plataforma/dashboard/workforce/areas/<uuid:public_id>/eliminar/", ATSWorkforceAreaDeleteView.as_view(), name="orbita_workforce_area_delete"),
    path("orbita/plataforma/dashboard/workforce/puestos/", ATSWorkforceDashboardView.as_view(), name="orbita_workforce_positions"),
    path("orbita/plataforma/dashboard/workforce/puestos/crear/", ATSWorkforcePositionCreateView.as_view(), name="orbita_workforce_position_create"),
    path("orbita/plataforma/dashboard/workforce/puestos/<uuid:public_id>/editar/", ATSWorkforcePositionUpdateView.as_view(), name="orbita_workforce_position_update"),
    path("orbita/plataforma/dashboard/workforce/puestos/<uuid:public_id>/eliminar/", ATSWorkforcePositionDeleteView.as_view(), name="orbita_workforce_position_delete"),
    path("orbita/plataforma/dashboard/workforce/planes/crear/", ATSWorkforcePlanCreateView.as_view(), name="orbita_workforce_plan_create"),
    path("orbita/plataforma/dashboard/workforce/planes/<uuid:public_id>/editar/", ATSWorkforcePlanUpdateView.as_view(), name="orbita_workforce_plan_update"),
    path("orbita/plataforma/dashboard/workforce/planes/<uuid:public_id>/eliminar/", ATSWorkforcePlanDeleteView.as_view(), name="orbita_workforce_plan_delete"),
    path("orbita/plataforma/dashboard/workforce/planes/<uuid:public_id>/enviar-aprobacion/", ATSWorkforcePlanActionView.as_view(action="send"), name="orbita_workforce_plan_send"),
    path("orbita/plataforma/dashboard/workforce/planes/<uuid:public_id>/aprobar/", ATSWorkforcePlanActionView.as_view(action="approve"), name="orbita_workforce_plan_approve"),
    path("orbita/plataforma/dashboard/workforce/planes/<uuid:public_id>/rechazar/", ATSWorkforcePlanActionView.as_view(action="reject"), name="orbita_workforce_plan_reject"),
    path("orbita/plataforma/dashboard/workforce/planes/<uuid:public_id>/cancelar/", ATSWorkforcePlanActionView.as_view(action="cancel"), name="orbita_workforce_plan_cancel"),
    path("orbita/plataforma/dashboard/workforce/planes/<uuid:public_id>/convertir-vacante/", ATSWorkforcePlanActionView.as_view(action="convert"), name="orbita_workforce_plan_convert"),
    ...
    path("orbita/plataforma/administracion/modulos/", ATSAdminUpdateModulesView.as_view(), name="orbita_admin_update_modules"),
    path("orbita/plataforma/administracion/limite-cvs/", ATSAdminUpdateCVLimitView.as_view(), name="orbita_admin_update_cv_limit"),
